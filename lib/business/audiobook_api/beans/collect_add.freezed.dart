...
/// Create a copy of CollectAdd
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CollectAddCopyWith<CollectAdd> get copyWith => _$CollectAddCopyWithImpl<CollectAdd>(this as CollectAdd, _$identity);

  /// Serializes this CollectAdd to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CollectAdd&&(identical(other.id, id) || other.id == id)&&(identical(other.libraryId, libraryId) || other.libraryId == libraryId)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.description, description)&&const DeepCollectionEquality().equals(other.books, books)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
@override
String toString() {
  return 'CollectAdd(id: $id, libraryId: $libraryId, name: $name, description: $description, books: $books, lastUpdate: $lastUpdate, createdAt: $createdAt)';
}
...
/// @nodoc
abstract mixin class $CollectAddCopyWith<$Res>  {
  factory $CollectAddCopyWith(CollectAdd value, $Res Function(CollectAdd) _then) = _$CollectAddCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CollectAddCopyWithImpl<$Res>
    implements $CollectAddCopyWith<$Res> {
  _$CollectAddCopyWithImpl(this._self, this._then);

  final CollectAdd _self;
  final $Res Function(CollectAdd) _then;
...
/// Adds pattern-matching-related methods to [CollectAdd].
extension CollectAddPatterns on CollectAdd {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CollectAdd value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CollectAdd() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CollectAdd value)  $default,){
final _that = this;
switch (_that) {
case _CollectAdd():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CollectAdd value)?  $default,){
final _that = this;
switch (_that) {
case _CollectAdd() when $default != null:
return $default(_that);case _:
...
class _CollectAdd implements CollectAdd {
  const _CollectAdd({@JsonKey(name: 'id') this.id, @JsonKey(name: 'libraryId') this.libraryId, @JsonKey(name: 'name') this.name, @JsonKey(name: 'description') this.description, @JsonKey(name: 'books') final  List<Books>? books, @JsonKey(name: 'lastUpdate') this.lastUpdate, @JsonKey(name: 'createdAt') this.createdAt}): _books = books;
  factory _CollectAdd.fromJson(Map<String, dynamic> json) => _$CollectAddFromJson(json);
...
@pragma('vm:prefer-inline')
_$CollectAddCopyWith<_CollectAdd> get copyWith => __$CollectAddCopyWithImpl<_CollectAdd>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CollectAddToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CollectAdd&&(identical(other.id, id) || other.id == id)&&(identical(other.libraryId, libraryId) || other.libraryId == libraryId)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.description, description)&&const DeepCollectionEquality().equals(other._books, _books)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// @nodoc
abstract mixin class _$CollectAddCopyWith<$Res> implements $CollectAddCopyWith<$Res> {
  factory _$CollectAddCopyWith(_CollectAdd value, $Res Function(_CollectAdd) _then) = __$CollectAddCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'id') String? id,@JsonKey(name: 'libraryId') String? libraryId,@JsonKey(name: 'name') String? name,@JsonKey(name: 'description') dynamic description,@JsonKey(name: 'books') List<Books>? books,@JsonKey(name: 'lastUpdate') int? lastUpdate,@JsonKey(name: 'createdAt') int? createdAt
});
...
/// @nodoc
class __$CollectAddCopyWithImpl<$Res>
    implements _$CollectAddCopyWith<$Res> {
  __$CollectAddCopyWithImpl(this._self, this._then);

  final _CollectAdd _self;
  final $Res Function(_CollectAdd) _then;
