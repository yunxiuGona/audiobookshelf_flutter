...
part of 'collect_floder_add.dart';
...
/// Create a copy of CollectFloderAdd
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CollectFloderAddCopyWith<CollectFloderAdd> get copyWith => _$CollectFloderAddCopyWithImpl<CollectFloderAdd>(this as CollectFloderAdd, _$identity);

  /// Serializes this CollectFloderAdd to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CollectFloderAdd&&(identical(other.id, id) || other.id == id)&&(identical(other.libraryId, libraryId) || other.libraryId == libraryId)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.description, description)&&const DeepCollectionEquality().equals(other.books, books)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
@override
String toString() {
  return 'CollectFloderAdd(id: $id, libraryId: $libraryId, name: $name, description: $description, books: $books, lastUpdate: $lastUpdate, createdAt: $createdAt)';
}
...
/// @nodoc
abstract mixin class $CollectFloderAddCopyWith<$Res>  {
  factory $CollectFloderAddCopyWith(CollectFloderAdd value, $Res Function(CollectFloderAdd) _then) = _$CollectFloderAddCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CollectFloderAddCopyWithImpl<$Res>
    implements $CollectFloderAddCopyWith<$Res> {
  _$CollectFloderAddCopyWithImpl(this._self, this._then);

  final CollectFloderAdd _self;
  final $Res Function(CollectFloderAdd) _then;
...
/// Adds pattern-matching-related methods to [CollectFloderAdd].
extension CollectFloderAddPatterns on CollectFloderAdd {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CollectFloderAdd value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CollectFloderAdd() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CollectFloderAdd value)  $default,){
final _that = this;
switch (_that) {
case _CollectFloderAdd():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CollectFloderAdd value)?  $default,){
final _that = this;
switch (_that) {
case _CollectFloderAdd() when $default != null:
return $default(_that);case _:
...
class _CollectFloderAdd implements CollectFloderAdd {
  const _CollectFloderAdd({@JsonKey(name: 'id') this.id, @JsonKey(name: 'libraryId') this.libraryId, @JsonKey(name: 'name') this.name, @JsonKey(name: 'description') this.description, @JsonKey(name: 'books') final  List<Books>? books, @JsonKey(name: 'lastUpdate') this.lastUpdate, @JsonKey(name: 'createdAt') this.createdAt}): _books = books;
  factory _CollectFloderAdd.fromJson(Map<String, dynamic> json) => _$CollectFloderAddFromJson(json);
...
@pragma('vm:prefer-inline')
_$CollectFloderAddCopyWith<_CollectFloderAdd> get copyWith => __$CollectFloderAddCopyWithImpl<_CollectFloderAdd>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CollectFloderAddToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CollectFloderAdd&&(identical(other.id, id) || other.id == id)&&(identical(other.libraryId, libraryId) || other.libraryId == libraryId)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.description, description)&&const DeepCollectionEquality().equals(other._books, _books)&&(identical(other.lastUpdate, lastUpdate) || other.lastUpdate == lastUpdate)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// @nodoc
abstract mixin class _$CollectFloderAddCopyWith<$Res> implements $CollectFloderAddCopyWith<$Res> {
  factory _$CollectFloderAddCopyWith(_CollectFloderAdd value, $Res Function(_CollectFloderAdd) _then) = __$CollectFloderAddCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'id') String? id,@JsonKey(name: 'libraryId') String? libraryId,@JsonKey(name: 'name') String? name,@JsonKey(name: 'description') dynamic description,@JsonKey(name: 'books') List<Books>? books,@JsonKey(name: 'lastUpdate') int? lastUpdate,@JsonKey(name: 'createdAt') int? createdAt
});
...
/// @nodoc
class __$CollectFloderAddCopyWithImpl<$Res>
    implements _$CollectFloderAddCopyWith<$Res> {
  __$CollectFloderAddCopyWithImpl(this._self, this._then);

  final _CollectFloderAdd _self;
  final $Res Function(_CollectFloderAdd) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? libraryId = freezed,Object? name = freezed,Object? description = freezed,Object? books = freezed,Object? lastUpdate = freezed,Object? createdAt = freezed,}) {
  return _then(_CollectFloderAdd(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String?,libraryId: freezed == libraryId ? _self.libraryId : libraryId // ignore: cast_nullable_to_non_nullable
as String?,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String?,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
